...
class RenderWidget(QWidget):
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        self.actorCombo.addItem("obj 1", Renderer.ActorType.OBJ1)
        self.actorCombo.addItem("obj 2", Renderer.ActorType.OBJ2)
        self.actorCombo.addItem("obj 3", Renderer.ActorType.OBJ3)
        self.actorCombo.addItem("obj 4", Renderer.ActorType.OBJ4)
        self.actorCombo.addItem("obj 5", Renderer.ActorType.OBJ5)
        self.actorCombo.addItem("obj 6", Renderer.ActorType.OBJ6)
        self.actorCombo.addItem("obj 7", Renderer.ActorType.OBJ7)
        self.actorCombo.addItem("obj 8", Renderer.ActorType.OBJ8)
        self.actorCombo.addItem("obj 9", Renderer.ActorType.OBJ9)
        self.actorCombo.addItem("obj 10", Renderer.ActorType.OBJ10)
