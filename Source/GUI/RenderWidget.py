...
class RenderWidget(QWidget):
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        self.actorCombo.addItem("Sphere TSL", Renderer.ActorType.SPHERETESSELLATION)
        ...
        label = QLabel("H: ")
        self.hLayout_.addWidget(label)
        self.hSpin_ = QSpinBox()
        self.hSpin_.setMinimum(10)
        self.hSpin_.setMaximum(50)
        self.hSpin_.setSingleStep(5)
        self.hSpin_.valueChanged.connect(self._renderer.setH)
        self.hLayout_.addWidget(self.hSpin_)
        self._bottomLayout.addLayout(self.hLayout_)

        self.vLayout_ = QHBoxLayout()               
        label = QLabel("V: ")
        self.vLayout_.addWidget(label)
        self.vSpin_ = QSpinBox()
        self.vSpin_.setMinimum(10)
        self.vSpin_.setMaximum(50)
        self.vSpin_.setSingleStep(5)
        self.vSpin_.valueChanged.connect(self._renderer.setH)
        self.vLayout_.addWidget(self.vSpin_)
        self._bottomLayout.addLayout(self.vLayout_)

        label = QLabel("Radius: ")
        self.radiusLayout_ = QHBoxLayout()    
        self.radiusLayout_.addWidget(label)
        self.radiusSpin_ = QDoubleSpinBox()
        self.radiusSpin_.setMinimum(1.0)
        self.radiusSpin_.setMaximum(3.0)
        self.radiusSpin_.setSingleStep(0.5)
        self.radiusSpin_.valueChanged.connect(self._renderer.setRadius)
        self.radiusLayout_.addWidget(self.radiusSpin_)
        self._bottomLayout.addLayout(self.radiusLayout_)
